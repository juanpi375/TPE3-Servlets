...
import dto.QueryCareerElementDTO;
...
//	el cual es retornado
	public ReportDTO getReport(){
		...
		TypedQuery<QueryCareerElementDTO> q = em.createQuery( "SELECT new dto.QueryCareerElementDTO(c.name, m.startYear,m.graduationYear ,concat(s.name, ' ', s.surname)) FROM Matriculation m JOIN m.career c "+
